...
const AdminSecurityDashboardPage = ({location, history}) => {
    ...
    const getCostOfCyberAttackBySector = async (sector) => {
        ...
        if (costOfCyberAttackBySectorRef.exists) {
            ...
            console.log('costOfCyberAttackBySector', costOfCyberAttackBySector);
                    ...
                    <div>
                        {
                            ...
                            <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', marginTop: '25px'}}>
                                ...
                                <div style={{alignSelf: 'center'}}>
                                    <p style={{color: 'rgb(64, 84, 106)', fontWeight: 'bold'}}>{costImpactOfCyberAttackByCountry} millions USD$</p>
                                </div>
                            </div>
...
export default withAuthorization(authCondition)(withRouter(AdminSecurityDashboardPage));
